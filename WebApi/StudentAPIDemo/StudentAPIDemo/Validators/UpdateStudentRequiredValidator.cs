...
namespace StudentAPIDemo.Validators
{
    public class UpdateStudentRequiredValidator : AbstractValidator<UpdateStudentRequest>
    {
        public UpdateStudentRequiredValidator(IStudentRepository studentRepository)
        {
